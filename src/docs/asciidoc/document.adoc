...
=== Board 전체 정렬로 불러오기
==== curl request
include::{snippets}/R_getAllBoardsBySort/curl-request.adoc[]
==== request parameter
include::{snippets}/R_getAllBoardsBySort/request-parameters.adoc[]
==== response fields
include::{snippets}/R_getAllBoardsBySort/response-fields.adoc[]
==== response data
include::{snippets}/R_getAllBoardsBySort/response-body.adoc[]
